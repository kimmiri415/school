...
<div class="container" style="width: 1000px; margin: 0 auto;">
	<div>
		<h3>문서 객체 모델(DOM)</h3>
		HTML과 XML문서에 대한 프로그래밍 인터페이스 <br /> 문서에 대한 구조적 정보를 제공하고 문서 구조나 외양 및
		내용을 <br /> 바꿀 수 있도록 프로그램에서 접근하는 방법을 제공함 <br /> DOM은 속성과 메소드를 가지는 객체와
		<br />
		<mark>노드</mark>
		와 트리구조로 표현됨<br /> 웹페이지를 스크립트나 다른 개발 언어로 접근 시 필수적
	</div>
	<div>
		<h3>document 객체</h3>
	...
	<div>
		<div>
			...
			<div>
				<span name='bbb'>1번</span> <span>2번</span> <span name='aaa'>3번</span>
				<span>4번</span> <span name='bbb'>5번</span> <span>6번</span>
			</div>
		</div>
	</div>
	<div>
