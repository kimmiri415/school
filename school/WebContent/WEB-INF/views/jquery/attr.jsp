...
<script src="${context}/resources/js/attr.js">/* java의 iport와 같다.*/
</script>
<script type="text/javascript">
$(document).ready(function(){/*콜백메서드*/
	alert('callback함수 가 실행되었습니다. !!');
	$('#sampleBox1').mouseover(function() {
		attr.attrDemo('${context}/resources/img/member/simpson.jpeg');
	});
